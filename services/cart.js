...
async function getProductsById( customer_id ) {
...
async function updateProduct( item_id, quantity ) {
    let [err, result] = await to( db.cartModel.findAll({
        where:{
            item_id: item_id
        }
...
async function deleteProducts( customer_id ) {
...
async function getTotalAmount( customer_id ) {
    let [err, result] = await to( db.cartModel.findAll({
        where: {
            customer_id: customer_id
        }
...
module.exports = {
    getProductsById, addProducts, updateProduct,
    deleteProducts, getTotalAmount, deleteOneProduct
}